import { IReservation } from "@modules/reservation/entities/definitions/reservation.interface";
...
export abstract class ReservationRepository {
    ...
    abstract findAll(start_date:Date, end_date:Date): Promise<IReservation[]>;
